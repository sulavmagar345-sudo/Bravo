...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="home-page" ref={rootRef}>
      ...
      <section className="home-closing"><div className="container home-closing__inner" data-reveal><p className="home-kicker home-kicker--light">Your next chapter</p><h2>Ready to Start Your Journey?</h2><p>Explore the program that fits your goals, or book a table with us.</p><div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}><Link className="btn btn--cream" to="/programs">Explore Programs</Link><Link className="btn btn--outline-light" to="/book">Book Now</Link><Link className="btn btn--outline-light" to="/contact">Contact Us</Link></div></div></section>
    </div>
  );
};
